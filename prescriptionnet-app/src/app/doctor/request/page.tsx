...
export default function DoctorRequestAccessPage() {
      ...
      <main style={{ maxWidth: '800px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '15px', color: '#64748b' }}>
            Search for a patient by ID to configure signature-verified data authorization
          </p>
        </div>
                ...
                <div>
                  {hasConsent ? (
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                      ...
                      <button
                        onClick={() => router.push(`/doctor/records/${searchedPatientId}`)}
                        style={{
                          background: '#1e293b',
                          color: '#f1f5f9',
                          border: '1px solid #334155',
